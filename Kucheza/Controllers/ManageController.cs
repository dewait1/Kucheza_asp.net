...
using Kucheza.Models;

namespace Kucheza.Controllers
{
    [Authorize]
    public class ManageController : Controller
    {
        ...
        public ActionResult Edit()
        {
            ...
            if (ModelState.IsValid)
            {
                model.opis = user.opis;
                model.wiek = user.wiek;
                model.dzienUrodzin = user.dzienUrodzin;
                model.miesiacUrodzin = user.miesiacUrodzin;
                model.rokUrodzin = user.miesiacUrodzin;
                model.aktualnaPraca = user.aktualnaPraca;
                model.religia = user.religia;
                model.opcjaPolityczna = user.opcjaPolityczna;
                model.ulubionyCytat = user.ulubionyCytat;
                model.wyksztalcenie = user.wyksztalcenie;
                model.zdjecieProfilowe = user.zdjecieProfilowe;
                model.plec = user.plec;
            }
        ...
        //                user.dzienUrodzin = model.dzienUrodzin;
        //                user.miesiacUrodzin = model.miesiacUrodzin;
        //                user.rokUrodzin = model.miesiacUrodzin;
        //                user.aktualnaPraca = model.aktualnaPraca;
        //                user.religia = model.religia;
        //                user.opcjaPolityczna = model.opcjaPolityczna;
        //                user.ulubionyCytat = model.ulubionyCytat;
        //                user.wyksztalcenie = model.wyksztalcenie;
